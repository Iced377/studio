...
5.  **Micronutrients Overview (Portion-Specific):**
    ...
    *   **If a user provides a specific quantity for a nutrient (e.g., "50,000 IU" for D3, or "480 EPA and 320 DHA" for Omega-3 components):**
        ...
        *   **Avoid Vague Statements:** For user-specified nutrients with quantities, do NOT output "Varies, check label", "Varies by brand", "Varies by dose", or similar vague phrases for the 'amount'. Use the amount the user gave.
